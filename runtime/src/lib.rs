...
#[docify::export(vibly_signed_extra)]
...
impl WeightToFeePolynomial for WeightToFee {
    ...
    fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
        // In Rococo, extrinsic base weight is mapped to 1 MILLI_UNIT. vibly-chain maps it to
        // 1/10 of that value.
        let p = MILLI_UNIT / 10;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: alloc::borrow::Cow::Borrowed("vibly-chain-runtime"),
    impl_name: alloc::borrow::Cow::Borrowed("vibly-chain-runtime"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 0,
