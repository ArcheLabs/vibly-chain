use crate as pallet_agent_incentives;
use frame::{
...
pub const REWARD_RESERVE: u64 = 98;
...
impl pallet_agent_staking::Config for Test {
    type WeightInfo = ();
    type IdentityProvider = IdentityCore;
    type Currency = Balances;
    type RuntimeHoldReason = RuntimeHoldReason;
...
impl crate::Config for Test {
    ...
    type Currency = Balances;
    type AdminOrigin = frame_system::EnsureRoot<u64>;
    type RewardReserveAccount = ConstU64<REWARD_RESERVE>;
    type MaxExternalIdLen = ConstU32<64>;
    type MaxSettlementParticipants = ConstU32<16>;
}
